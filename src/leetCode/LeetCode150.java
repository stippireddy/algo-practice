 ...
 *     do not attempt to cover all the corner cases such as division by zero, integer
 *     overflow/underflow etc as it is assumed that the LeetCode OJ explicitly states to assume that
